    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row">
        ...
        <div dir="rtl" class="col-lg-1 col-md-2">
            <a href="/About_us/Foundation/add"><button dir="rtl" class="add"><b>+</b></button></a>
        </div>
        <div class="col-lg-12 col-md-10">
            ...
            <table id="myTable" dir="rtl" data-aos="fade-up">
                ...
                @foreach ($Fous as $Fou)
                        <tr class="tr-td" onclick="window.location='{{url('/الهيئة/About_us/Foundation')}}';">
                            <td>{{$Fou->subject}}</td>
                            <td colspan="2" style="text-align: center"><a href="{{url('/About_us/Foundation/edit',$Fou->id)}}" class="w3-padding w3-xlarge w3-text-cyan"><i class="material-icons">edit</i></a></td>
                        </tr>
                @endforeach
              </table>
