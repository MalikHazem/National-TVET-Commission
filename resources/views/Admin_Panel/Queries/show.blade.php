    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row">
        ...
        <div dir="rtl" class="col-lg-1 col-md-2">
            <button dir="rtl" class="add"><b>+</b></button>
        </div>
            ...
            <table id="myTable" dir="rtl" data-aos="fade-up">
                ...
                @foreach ($queries as $querie)
                        <tr class="tr-td">
                            ...
                            <td><?php echo substr($querie->message,0,65) ?>...</td>
                            <td colspan="2" style="text-align: center"><a href="{{url('Queries/destroy',$querie->id)}}" class="w3-padding w3-xlarge w3-text-red"><i class="material-icons">delete</i></a></td>
                        </tr>
                    @endforeach
              </table>
