        ...
        <div class="col-lg-12 col-md-10">
            ...
            <table id="myTable" dir="rtl" data-aos="fade-up">
                ...
                @foreach ($Projects as $Project)
                        <tr class="tr-td" onclick="window.location='{{url('/الهيئة/Project')}}';">
                            <td>{{$Project->id}}</td>
                            <td>{{$Project->name}}</td>
                            ...
                            <td>{{$Project->goals}}</td>
                            <td>{{$Project->idea}}</td>
                            <td colspan="2" style="text-align: center"><a href="{{url('/Project/edit',$Project->id)}}" class="w3-padding w3-xlarge w3-text-cyan"><i class="material-icons">edit</i></a>
                            <a href="{{url('/Project/destroy',$Project->id)}}" class="w3-padding w3-xlarge w3-text-red"><i class="material-icons">delete</i></a></td>
                        </tr>
                @endforeach
              </table>
