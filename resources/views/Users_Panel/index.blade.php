...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="{{url('vendor2/animate.css/animate.min.css')}}" rel="stylesheet">
  <link href="{{url('vendor2/aos/aos.css')}}" rel="stylesheet">
  <link href="{{url('vendor2/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
  <link href="{{url('vendor2/bootstrap-icons/bootstrap-icons.css')}}" rel="stylesheet">
  <link href="{{url('vendor2/glightbox/css/glightbox.min.css')}}" rel="stylesheet">
  <link href="{{url('vendor2/swiper/swiper-bundle.min.css')}}" rel="stylesheet">

  <!-- Template Main CSS File -->
  <link href="{{url('css2/style.css')}}" rel="stylesheet">
...
<body>
  ...
  <!-- Vendor JS Files -->
  <script src="{{url('vendor2/purecounter/purecounter.js')}}"></script>
  <script src="{{url('vendor2/aos/aos.js')}}"></script>
  <script src="{{url('vendor2/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
  <script src="{{url('vendor2/glightbox/js/glightbox.min.js')}}"></script>
  <script src="{{url('vendor2/isotope-layout/isotope.pkgd.min.js')}}"></script>
  <script src="{{url('vendor2/swiper/swiper-bundle.min.js')}}"></script>
  <script src="{{url('vendor2/waypoints/noframework.waypoints.js')}}"></script>
  <script src="{{url('vendor2/php-email-form/validate.js')}}"></script>
