      ...
      <div class="row">
        ...
        <div class="col-lg-12 col-md-10">
            ...
            <table style="text-align: right" class="table"  id="myTable" dir="rtl" data-aos="fade-up">
                <tr id="tr-th">
                    <th style="width:15%">الرقم القانون</th>
                    <th style="width: 50%">اسم القانون</th>
                </tr>
                @foreach ($Laws as $law)
                        <tr class="tr-td">
                            <td style="width: 10%">{{$law->num_laws}}</td>
                            <td style="width: 20%"><a href="{{url('/About_us/Laws',$law->id)}}">{{$law->name}}</td>
                        </tr>
                @endforeach
              </table>
